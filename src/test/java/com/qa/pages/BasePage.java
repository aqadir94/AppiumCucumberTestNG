...
public class BasePage {
    ...
    public void waitForVisibility(MobileElement e) {
        WebDriverWait wait = new WebDriverWait(DriverManager.getDriver(), TestUtils.WAIT);
    ...
    public void click(By e, String msg) {
        waitForVisibility(e);
        utils.log().info(msg);
        DriverManager.getDriver().findElement(e).click();
    }
    ...
    public String getAttribute(By e, String attribute) {
        waitForVisibility(e);
        return DriverManager.getDriver().findElement(e).getAttribute(attribute);
    }
